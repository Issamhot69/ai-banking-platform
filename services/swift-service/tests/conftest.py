...
TEST_USER_ID = "eeeeeeee-ffff-aaaa-bbbb-cccccccccccc"
TEST_EMAIL = "swift_test_9999@bank.com"
...
async def create_tables():
    async with test_engine.begin() as conn:
        ...
        await conn.execute(text("""
            ...
            VALUES (:id, :email, 'testhash', 'Test', 'Swift',
        ...
        await conn.execute(text("""
            ...
            VALUES (:id, :user_id, '8888888888', 'MA860015500108888888888',
                'checking', 'EUR', 50000, 50000, 'active', true, 100000, 500000, NOW(), NOW())
