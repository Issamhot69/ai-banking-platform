...
TEST_USER_ID = "66666666-7777-8888-9999-aaaaaaaaaaaa"
TEST_EMAIL = "crypto_test_9999@bank.com"
...
async def create_tables():
    async with test_engine.begin() as conn:
        ...
        await conn.execute(
            text("INSERT INTO users (id, email, password_hash, first_name, last_name, is_active, is_verified, kyc_status, is_2fa_enabled, created_at, updated_at) VALUES (:id, :email, 'testhash', 'Test', 'Crypto', true, true, 'pending', false, NOW(), NOW()) ON CONFLICT (email) DO NOTHING"),
